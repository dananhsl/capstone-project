...
`,DragHandle=styled_components_browser_esm.ZP.div`
	position: absolute;
	inset: 0;
	z-index: -1;
...
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");function BankAccount(props){const{setNodeRef,attributes,listeners,transition,transform,isDragging}=(0,sortable_esm.nB)({id:props.id}),style={transition,transform:`translate3d(0, ${(null==transform?void 0:transform.y)||0}px, 0)`,opacity:isDragging?.5:1};return(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:(0,jsx_runtime.jsxs)(Section,{style,children:[(0,jsx_runtime.jsx)(DragHandle,{ref:setNodeRef,...attributes,...listeners}),(0,jsx_runtime.jsxs)(Content,{children:[(0,jsx_runtime.jsx)("h2",{children:props.accountName}),(0,jsx_runtime.jsx)("h3",{children:props.bankName}),(0,jsx_runtime.jsxs)("p",{children:[props.value," €"]}),(0,jsx_runtime.jsx)("button",{type:"button",onClick:props.onNavigate,children:"Transactions"}),(0,jsx_runtime.jsx)("button",{type:"button",onClick:props.onEdit,children:"Edit"}),(0,jsx_runtime.jsx)("button",{type:"button",onClick:props.onDelete,children:"Delete"})]})]})})}const Default=(args=>(0,jsx_runtime.jsx)(BankAccount,{...args})).bind({});Default.args={accountName:"Girokonto",bankName:"Volksbank",accountValue:200,onDelete:()=>{console.log("delete")}};const BankAccount_stories={title:"Bankaccount",component:BankAccount};Default.parameters={storySource:{source:"args => <BankAccount {...args} />"},...Default.parameters};const __namedExportsOrder=["Default"]},"./src/components/Button/Button.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,__namedExportsOrder:()=>__namedExportsOrder,default:()=>Button_stories});var react_router=__webpack_require__("./node_modules/react-router/index.js");function rem(n){return`${n}rem`}const styled=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js").ZP.button`
	padding: 0.5em 1em;
