(globalThis.webpackChunkreact_app=globalThis.webpackChunkreact_app||[]).push([[179],{"./src/components/BankAccount/BankAccount.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,__namedExportsOrder:()=>__namedExportsOrder,default:()=>BankAccount_stories});const Section=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js").ZP.section`
	margin: 20px auto;
	padding: 10px;
	border: 4px solid var(--blue);
	border-radius: 30px;
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");function BankAccount(_ref){let{accountName,bankName,accountValue}=_ref;return(0,jsx_runtime.jsxs)(Section,{children:[(0,jsx_runtime.jsx)("h2",{children:accountName}),(0,jsx_runtime.jsx)("h3",{children:bankName}),(0,jsx_runtime.jsxs)("p",{children:[accountValue," €"]})]})}const Default=args=>(0,jsx_runtime.jsx)(BankAccount,{...args}),story=Default.bind({});story.args={accountName:"Girokonto",bankName:"Volksbank",accountValue:200};const BankAccount_stories=story;Default.parameters={storySource:{source:"args => <BankAccount {...args} />"},...Default.parameters};const __namedExportsOrder=["Default"]},"./src/components/Button/Button.stories.js":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{"use strict";function rem(n){return`${n}rem`}__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,__namedExportsOrder:()=>__namedExportsOrder,default:()=>Button_stories});const styled=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js").ZP.button`
	padding: 0.5em 1em;
